const faqData = {
  az: [
    ...
    },
    {
      ...
      answer: "Yolu proqramında üç dil mövcuddur: Azərbaycan, Rus, İngilis.",
    },
  ],
  ru: [
    {
  ...
  tr: [
    ...
    },
    {
      ...
      answer: "İş ilanları, kullanıcı etkinliğine bağlı olarak güncellenir.",
    },
    {
      id: 6,
    ...
    },
    {
      ...
      answer: "Yolu programında üç dil mevcuttur: Azerice, Rusça, İngilizce.",
    },
  ],
  en: [
    {
...
const faqPage = (req, res) => {
  try {
    ...
    const data = faqData[lang] || faqData.en; // Default to English if lang is not found
    ...
    res.status(500).json({
      error: true,
      message: "An error occurred while fetching the FAQ data.",
    });
  }
};
